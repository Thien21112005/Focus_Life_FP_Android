...
public class FocusTaskAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(@NonNull TaskItem item) {
            ...
            root.setBackgroundResource(selected ? R.drawable.bg_focus_selection : R.drawable.bg_focus_task_card);
        ...
        private String buildMeta(@NonNull FocusTask task) {
            String category = TextUtils.isEmpty(task.category) ? "Chưa phân loại" : task.category;
            return category + " · " + task.completedPomodoros + "/" + Math.max(1, task.estimatedPomodoros) + " Pomodoro";
        }
